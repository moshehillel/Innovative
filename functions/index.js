...
async function classifyIncomingEmail(subject, from, body, attachments) {
  ...
  const res = await client.messages.create({
    ...
    system: [
      ...
      "  Single Point, FactorView, Compass FS, Apex, Sunbelt Finance, and",
      ...
      "- CSX (donotreply.erp@csx.com / @csx.com): subject",
      "  'CSX Billing- 09/15/26' with a CSXARTRUCK / AR XLS list is a",
      "  railroad account billing summary (invoices due, dispute window).",
      "  Classify as statement, not carrier_invoice. There is no per-load",
      "  freight bill PDF to enter.",
