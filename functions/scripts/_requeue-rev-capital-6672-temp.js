"use strict";
/**
 * Requeue REV Capital Invoice #6672 after factor Invoice # classification fix.
 */
...
const MESSAGE_ID =
  "AAMkAGU5MDg4MmNlLTdjNGYtNGI2ZC1iYjMxLTA1YzI2ZmIwZTczMgBGAAAAAAAqntx80xUMS" +
    "q6IxxEc6_lyBwAKzphD0oUnQrPDK_2RRTFaAAAAAAEMAAAKzphD0oUnQrPDK_2RRTFaAAdBrc4JAAA=";
const QUEUE_URLS = [
...
(async () => {
  console.log("=== requeue REV Capital Invoice #6672 ===");
