"use strict";
/**
 * Requeue RM Capital REF# 267594 after OTHER-cover invoice keep fix.
 */
...
const MESSAGE_ID =
  "AAMkAGU5MDg4MmNlLTdjNGYtNGI2ZC1iYjMxLTA1YzI2ZmIwZTczMgBGAAAAAAAqntx80xUMS" +
    "q6IxxEc6_lyBwAKzphD0oUnQrPDK_2RRTFaAAAAAAEMAAAKzphD0oUnQrPDK_2RRTFaAAdLY1ovAAA=";
const QUEUE_URLS = [
...
(async () => {
  console.log("=== requeue RM Capital REF# 267594 ===");
  const before = await getDoc("gmailQueue", MESSAGE_ID);
  console.log("before", JSON.stringify({
    status: before && before.status,
    outcome: before && before.outcome,
    summary: before && before.summary,
  }));
